...
The same uniform Bz in the 2D axisymmetric cylinder format, on a posed FIELDMAP.
...
- Map `../maps/sol_cyl.g4blmap`, cylinder format, carried by a `FIELDMAP`.
...
The 4x4 matrix against the closed form, and against grid_sol: the same field in the other format has to track the same.
