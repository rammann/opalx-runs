...
**QUADRUPOLE**, L = 0.3 m. QUADRUPOLE K1 = +2 m^-2: defocuses an electron in x.
...
- `Case.read_plane` reads the co-moving phase space from `quad_defoc_x.h5`: positions in the beam frame [m], momenta in β·γ rotated into the reference direction → x′ = px/pz, y′ = py/pz, δ = |p|/p₀ − 1.
